...
let camera, look, scene, renderer;
...
function init() {
    ...
    rh_loader.load( './public/models/robot.3dm', function ( rh_object ) {
        ...
        rh_object.traverse( n => {
            ...
            else if (n.name === "rob_skeleton") robot_parts.skeleton_polyline = n;
            else if (n.name === "rob_zone") robot_parts.zone = n;
            ...
            if (n.type === "Line"){
                ...
                let newline = new Line2(geom, matLine);
                newline.position.set(0,0,0);
                //newline.boundingSphere = new THREE.Sphere(newline.position, 1);
